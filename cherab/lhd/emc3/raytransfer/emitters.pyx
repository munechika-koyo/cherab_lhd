...
cdef class Discrete3DMeshRayTransferIntegrator(RayTransferIntegrator):
    ...
    with the `Discrete3DMeshRayTransferEmitter` material class and the `Discrete3DMesh` 
    ...
    cpdef Spectrum integrate(self, Spectrum spectrum, World world, Ray ray, Primitive primitive,
        ...
        if not isinstance(material, Discrete3DMeshRayTransferEmitter):
            raise TypeError('Only Discrete3DMeshRayTransferEmitter material is supported by Discrete3DMeshRayTransferIntegrator')
...
cdef class Discrete3DMeshRayTransferEmitter(InhomogeneousVolumeEmitter):
    ...
    .. prompt:: python >>> auto
        ...
        >>> from cherab.lhd.tools.raytransfer import Discrete3DMeshRayTransferEmitter
        >>>
    ...
    def __init__(self, object index_function not None, int bins=0, double integration_step=0.01, VolumeIntegrator integrator=None):
    ...
    cpdef Spectrum emission_function(self, Point3D point, Vector3D direction, Spectrum spectrum,
        ...
        isource = self.index_function(point.x, point.y, point.z)  # index of the light source in 3D mesh
